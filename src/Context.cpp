...
namespace ez::imgui {
		...
		, mousePress{false, false, false}
	{
		...
		io.KeyMap[ImGuiKey_Tab] = static_cast<std::int32_t>(ez::Key::Tab);
		io.KeyMap[ImGuiKey_LeftArrow] = static_cast<std::int32_t>(ez::Key::Left);
		io.KeyMap[ImGuiKey_RightArrow] = static_cast<std::int32_t>(ez::Key::Right);
		io.KeyMap[ImGuiKey_UpArrow] = static_cast<std::int32_t>(ez::Key::Up);
		io.KeyMap[ImGuiKey_DownArrow] = static_cast<std::int32_t>(ez::Key::Down);
		io.KeyMap[ImGuiKey_PageUp] = static_cast<std::int32_t>(ez::Key::PageUp);
		io.KeyMap[ImGuiKey_PageDown] = static_cast<std::int32_t>(ez::Key::PageDown);
		io.KeyMap[ImGuiKey_Home] = static_cast<std::int32_t>(ez::Key::Home);
		io.KeyMap[ImGuiKey_End] = static_cast<std::int32_t>(ez::Key::End);
		io.KeyMap[ImGuiKey_Insert] = static_cast<std::int32_t>(ez::Key::Insert);
		io.KeyMap[ImGuiKey_Delete] = static_cast<std::int32_t>(ez::Key::Delete);
		io.KeyMap[ImGuiKey_Backspace] = static_cast<std::int32_t>(ez::Key::Backspace);
		io.KeyMap[ImGuiKey_Space] = static_cast<std::int32_t>(ez::Key::Space);
		io.KeyMap[ImGuiKey_Enter] = static_cast<std::int32_t>(ez::Key::Enter);
		io.KeyMap[ImGuiKey_Escape] = static_cast<std::int32_t>(ez::Key::Escape);
		io.KeyMap[ImGuiKey_KeyPadEnter] = static_cast<std::int32_t>(ez::Key::KPEnter);
		io.KeyMap[ImGuiKey_A] = static_cast<std::int32_t>(ez::Key::A);
		io.KeyMap[ImGuiKey_C] = static_cast<std::int32_t>(ez::Key::C);
		io.KeyMap[ImGuiKey_V] = static_cast<std::int32_t>(ez::Key::V);
		io.KeyMap[ImGuiKey_X] = static_cast<std::int32_t>(ez::Key::X);
		io.KeyMap[ImGuiKey_Y] = static_cast<std::int32_t>(ez::Key::Y);
		io.KeyMap[ImGuiKey_Z] = static_cast<std::int32_t>(ez::Key::Z);
	...
	bool Context::processEvent(const ez::InputEvent& ev) {
		...
		case ez::InEv::KeyPress: {
			std::uint32_t key = static_cast<std::uint32_t>(ev.key.code);
	...
	void Context::newFrame(window::Window & window) {
		...
		ez::window::captureMouse(any_mouse_button_down);
